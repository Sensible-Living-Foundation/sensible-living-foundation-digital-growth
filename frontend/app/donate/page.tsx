    ...
    <div>
      ...
      <section className="py-10" style={{ background: "#F0FDF4" }}>
        <div className="max-w-4xl mx-auto px-6">
          ...
          {/* @ts-ignore */}
          <givebutter-widget id="L4EEnM"></givebutter-widget>
        </div>
      </section>

      {/* Impact tiers + Givebutter donate form */}
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-gray-500 leading-relaxed mb-8 text-lg">
              We are building free financial literacy programs and vertical garden systems
              for underserved families in Phoenix. Your gift funds the direct cost of
              getting those programs off the ground.
            </p>
          ...
          <div className="space-y-6">
            ...
            >
              {/* @ts-ignore */}
              <givebutter-widget id="g6nWXg"></givebutter-widget>
            </div>
            ...
            <div className="card !p-8">
              ...
              <div className="space-y-3">
                ...
                <a
                  href="mailto:contact@sensiblelivingfoundation.org"
                  className="flex items-center justify-between p-3 rounded-lg border border-gray-100 hover:border-slf-green-mid transition-colors text-sm"
                >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <p className="font-serif text-2xl text-slf-charcoal leading-relaxed mb-6">
            &quot;We invest in human potential. By providing financial literacy tools and
            access to healthy food, we empower individuals to build a future where health
            and prosperity are not privileges but realities.&quot;
          </p>
      ...
      <section className="py-16" style={{ background: "#1B4332" }}>
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="text-green-200 mb-8">
            Every gift, at any amount, moves the mission forward.
          </p>
          <a
